...
- **E-mail Marketing Analytics**[query][file:143]
...
Projeto voltado à consolidação e análise de dados de mídia e performance para contas do grupo Accor por tempo determinado.[query]
...
- Ferramentas utilizadas: **Power BI, Supermetrics, GA4, Google Ads, Meta Ads e LinkedIn Ads**.[query]

### Consultor / Especialista em Web Analytics - Acceleration, now Choreograph
**Dezembro de 2023 - Dezembro de 2024 · Lisboa**

Atuação em governança de dados, consentimento e padronização de tracking em ambientes multinacionais.[query]
...
- Ferramentas utilizadas: **GA4, GTM, Power BI, Consent Mode e Looker Studio**.[query]
...
- Organização de processos, demandas e rotinas analíticas.[query]
...
- Aplicação de storytelling analítico para apoiar decisões de marketing.[query]
...
- Capacitação de equipes na leitura e uso estratégico dos dados.[query]

### Consultor em E-mail Marketing - Maximiliano de Jesus Ferreira Serviços - Autonomous
...
- Desenvolvimento de relatórios de performance e funil.[query]
...
- Produção de relatórios e recomendações de otimização.[query]
...
- Atuação com governança, segurança e mitigação de riscos.[query]
...
- Monitoramento de serviços e qualidade de entrega.[query]

## Formação Acadêmica

### Eduka Negócios
**Administração e Negócios**  
Agosto de 2025 - Dezembro de 2025.[query]

### ESPM Escola Superior de Propaganda e Marketing
**Métricas Digitais e Web Analytics / Web Analytics**  
Fevereiro de 2013 - Junho de 2013.[query]
...
- Certificação do Google Analytics.[query][file:143]

## Idiomas
- **Português**
- **Inglês** - Full Professional.[query][file:143]
...
- **Site pessoal:** www.ferreira.pro.br[query][file:143]